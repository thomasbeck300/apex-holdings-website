...
export function DesignTestimonial({ testimonials }: DesignTestimonialProps) {
  ...
  return (
    <div className="flex items-center justify-center min-h-[600px] overflow-hidden">
      <div ref={containerRef} className="relative w-full max-w-5xl px-6" onMouseMove={handleMouseMove}>
        ...
        <motion.div
          className="absolute -left-8 top-1/2 -translate-y-1/2 text-[28rem] font-bold text-foreground/[0.03] select-none pointer-events-none leading-none tracking-tighter hidden md:block"
        ...
        <div className="absolute -bottom-20 left-0 right-0 overflow-hidden opacity-[0.08] pointer-events-none hidden md:block">
          <motion.div
